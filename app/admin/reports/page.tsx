        ...
        {showResults && filteredTransactions.length > 0 && (
          <div className="space-y-6">
            ...
            <Card className="p-6 bg-white shadow">
              <h2 className="text-2xl font-bold text-gray-900 mb-6">Transaction Ledger</h2>
                ...
                <table className="w-full">
                  <thead>
                    <tr className="bg-gradient-to-r from-slate-600 to-slate-700 text-white">
                      ...
                      <th className="px-6 py-4 text-right font-semibold">Deposit</th>
                      <th className="px-6 py-4 text-right font-semibold">Withdraw</th>
                  ...
                  <tbody>
                    {filteredTransactions.map((transaction, index) => (
                      <tr key={index} className="border-b border-gray-200 hover:bg-gray-50 transition">
                        ...
                        <td className="px-6 py-4 text-gray-700">{transaction.date || 'N/A'}</td>
