    ...
    const handleLogin = (e)=>{
        ...
        setTimeout(()=>{
            if (username.trim() === "admin" && password === "12345") {
                ...
                const student = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$students$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["defaultStudents"].find((s)=>s.username === username.trim() && s.password === password);
                if (student) {
                    ...
                    if (customAccount) {
                        ...
                        const syncedAccount = allStudents.find((s)=>s.id === customAccount.id);
...
//# sourceMappingURL=_ad3394ee._.js.map