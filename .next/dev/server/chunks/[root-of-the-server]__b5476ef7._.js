...
"[project]/app/api/transactions/deposits/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    try {
        ...
        const deposit = new __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2f$Deposit$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Deposit"]({
            studentId,
            studentName,
            studentCode,
            amount,
        ...
        await deposit.save();
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(deposit, {
            status: 201
        });
    } catch (error) {
...
async function GET(req) {
    try {
        ...
        const deposits = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2f$Deposit$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Deposit"].find(query).sort({
            createdAt: -1
        });
        const response = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(deposits);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b5476ef7._.js.map