...
function ManageTransactions() {
    ...
    const filteredStudents = students.filter((s)=>s.name.toLowerCase().includes(searchQuery.toLowerCase()) || s.code.toLowerCase().includes(searchQuery.toLowerCase()));
    if (isLoading) {
...
_s(ManageTransactions, "XgrZg2NuaSojgZW/A28oUkYdC0Y=", false, function() {
    return [
...
//# sourceMappingURL=_7a7ed6bb._.js.map