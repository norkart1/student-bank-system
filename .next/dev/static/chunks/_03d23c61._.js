    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AdminDashboard.useEffect": ()=>{
            ...
            if (auth !== "true" || role !== "admin") {
                ...
                let withdrawn = 0;
                studentList.forEach({
                    "AdminDashboard.useEffect": (student)=>{
                        balance += student.balance || 0;
                        if (student.transactions) {
                            student.transactions.forEach({
                                "AdminDashboard.useEffect": (t)=>{
                                    if (t.type === 'deposit') {
...
_s(AdminDashboard, "9dY8ZiReFt3rs0aYD2yCZot78Xk=", false, function() {
    return [
...
//# sourceMappingURL=_03d23c61._.js.map