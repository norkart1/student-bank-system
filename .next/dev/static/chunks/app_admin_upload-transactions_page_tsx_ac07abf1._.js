...
function UploadTransactions() {
        ...
        reader.onload = (e)=>{
            try {
                ...
                const transactions = jsonData.map((row)=>({
                    ...
                    if (!t.studentCode) {
                        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].warning("Row skipped: Missing student code");
                        return false;
                    }
                    if (!t.date) {
                        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].warning(`Row skipped (${t.studentCode}): Missing date`);
                        return false;
                    }
                    if (![
                        "deposit",
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success(`✓ Loaded ${transactions.length} transactions`);
            } catch (error) {
                console.error("Error reading file:", error);
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Failed to read Excel file");
                setFileName("");
                setPreviewData([]);
            }
        };
    ...
    const handleUpload = async ()=>{
        ...
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success(`✓ Successfully uploaded ${result.successCount} transactions. ${result.failureCount > 0 ? `${result.failureCount} failed.` : ""}`);
            setPreviewData([]);
            setFileName("");
