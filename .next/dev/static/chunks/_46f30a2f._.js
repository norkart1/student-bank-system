...
const getPusherClient = ()=>{
    ...
    ;
    const pusherClient = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$pusher$2d$js$2f$dist$2f$web$2f$pusher$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"](("TURBOPACK compile-time value", "f9d7980c56db83a0605b") || '', {
        cluster: ("TURBOPACK compile-time value", "ap2") || 'mt1',
        forceTLS: true
    });
    return pusherClient;
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AdminDashboard.useEffect": ()=>{
            ...
            const studentRefreshInterval = setInterval({
                "AdminDashboard.useEffect.studentRefreshInterval": ()=>{
                    if (!showCreateForm && !showEditForm && !showDeleteConfirm && !showDepositModal && !showWithdrawModal) {
                        fetchStudents();
                    }
                }
            }["AdminDashboard.useEffect.studentRefreshInterval"], 2000);
            const now = new Date();
            const options = {
                day: 'numeric',
                month: 'short',
...
_s(AdminDashboard, "E8so7nKPf8ut2GAgUuKmzGnF5cI=", false, function() {
    return [
